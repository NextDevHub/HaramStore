    ...
    translation: {
      ...
      signUpPage: {
        ...
        passwordRequirements:
          "Password must be at least 8 characters long, include a number, and at least one uppercase letter.",
        createAccount: "Create Account",
  ...
  ar: {
    translation: {
      ...
      signUpPage: {
        ...
        confirmPassword: "تأكيد كلمة المرور",
        passwordRequirements:
          "يجب أن تكون كلمة المرور مكونة من 8 أحرف على الأقل، وتتضمن رقمًا وحرفًا كبيرًا واحدًا على الأقل.",
        createAccount: "إنشاء حساب",
